const getContentExperience = () => [
  {
    ...
    description:
      "Contributed to designing user-friendly and visually appealing interfaces for both web and mobile platforms. I collaborated closely with cross-functional teams to create intuitive user experiences, applying design principles and user feedback to enhance functionality and engagement.",
  },
  {
    id: 2,
    ...
    description:
      "The self-study program at Dicoding Indonesia focuses on front-end and back-end web development, improving my skills in creating responsive web applications and building systems.",
  },
  {
    id: 3,
